...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buttonText: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u05D4\u05E8\u05E9\u05DE\u05D4 \u05DC\u05E4\u05E2\u05D9\u05DC\u05D5\u05EA'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Required;
    details: Schema.Attribute.Component<'content.activity-details', false> &
      Schema.Attribute.Required;
    galleryImages: Schema.Attribute.Media<'images', true>;
    hasRegistration: Schema.Attribute.Boolean &
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'\u05D0\u05DC\u05E2\u05D3'>;
    ...
    > &
      Schema.Attribute.Private;
    page: Schema.Attribute.Enumeration<['training', 'therapy']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSliderHeroImageSliderHeroImage
  extends Struct.CollectionTypeSchema {
  collectionName: 'slider_hero_images';
  info: {
    displayName: 'Slider Hero Image';
    pluralName: 'slider-hero-images';
    singularName: 'slider-hero-image';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::slider-hero-image.slider-hero-image'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::slider-hero-image.slider-hero-image': ApiSliderHeroImageSliderHeroImage;
